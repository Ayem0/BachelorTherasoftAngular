...
export class RepetitionComponent {
  ...
  public form = new FormGroup({
    number: new FormControl(this.repetition?.number || 1, [Validators.required]),
    interval: new FormControl(this.repetition?.interval || Interval.weak, [Validators.required]), 
